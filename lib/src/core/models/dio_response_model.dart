...
class DioResponseModel {
  DioResponseModel({this.statusCode, this.message, this.errors});
  ...
  Map<String, dynamic> toJson() => {'status_code': statusCode, 'message': message, 'errors': errors?.toJson()};
}

class Errors {
  Errors({this.email, this.contactNumber, this.name, this.invalidCredentials, this.password, this.invalidDefaultPassword});
